...
Route53.prototype.createResourceRecordSet = function createResourceRecordSet (HostedZoneId, Name, Type, loadBalancerOrRecordValues, TTL) {
...
Route53.prototype.deleteHostedZone = function deleteHostedZone (domain) {
  return this.getHostedZone(domain)
    .then(hostedZone => hostedZone && this.awsApi.then(api => api.deleteHostedZone({Id: hostedZone.Id})))
...
Route53.prototype.getResourceRecordSet = function getResourceRecordSet (HostedZoneId, StartRecordName, StartRecordType) {
  var recordNameMask = new RegExp(`^${StartRecordName.replace(/\./g, '\\.')}\\.?$`)
  return this.awsApi
